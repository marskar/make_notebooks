...
.git/:
	curl --user 'marskar' https://api.github.com/user/repos --data '{"name":"make_notebooks","description":"Automate Jupyter notebook workflows nteract papermill and GNU Make."}'
	test -f README.rst || echo "Make Notebooks" >> README.rst
	git init
	git add --all
	git commit --message "First commit"
	git remote add origin https://github.com/marskar/make_notebooks.git
